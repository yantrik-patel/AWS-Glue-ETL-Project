...
AmazonS3_node1718379749023 = glueContext.create_dynamic_frame.from_catalog(database="mydatabase", table_name="product", transformation_ctx="AmazonS3_node1718379749023")



logger.info('print schema of AmazonS3_node1718379749023')
AmazonS3_node1718379749023.printSchema()

count = AmazonS3_node1718379749023.count()
print("Number of rows in AmazonS3_node1718379749023 dynamic frame: ", count)
logger.info('count for frame is {}'.format(count))



# Script generated for node Change Schema
ChangeSchema_node1718379770418 = ApplyMapping.apply(frame=AmazonS3_node1718379749023, mappings=[("marketplace", "string", "new_marketplace", "string"), ("customer_id", "long", "new_customer_id", "long"), ("product_id", "string", "new_product_id", "string"), ("seller_id", "string", "new_seller_id", "string"), ("sell_date", "string", "new_sell_date", "string"), ("quantity", "long", "new_quantity", "long"), ("year", "string", "new_year", "string")], transformation_ctx="ChangeSchema_node1718379770418")
...
ResolveChoice_node = ChangeSchema_node1718379770418.resolveChoice(specs = [('new_seller_id','cast:long')],
...
# Script generated for node Amazon S3
AmazonS3_node1718379777556 = glueContext.write_dynamic_frame.from_options(frame=dynamic_frame, connection_type="s3", format="glueparquet", connection_options={"path": "s3://glue-etl-project-yantrik/output/", "partitionKeys": []}, format_options={"compression": "uncompressed"}, transformation_ctx="AmazonS3_node1718379777556")
